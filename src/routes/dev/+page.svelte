    ...
    <div id="languages">
        <div>
            ...
            <div id="language-icons">
                ...
                <img
                    src="https://cdn.discordapp.com/emojis/403294924432211968.png?v=1"
                    alt="python"
                />
                <img
                    src="https://cdn.discordapp.com/emojis/403294965192458240.png?v=1"
                    alt="node"
                />
                <img
                    src="https://cdn.discordapp.com/emojis/403294977154875412.png?v=1"
                    alt="java"
                />
            </div>
        </div>
